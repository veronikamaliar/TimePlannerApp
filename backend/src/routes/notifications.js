...
router.post("/", authorize, createSingleNotification);     
router.post("/batch", authorize, createBatchNotifications);
router.get("/", authorize, getAllNotifications);
router.patch("/:id/read", authorize, markNotificationRead);
router.patch("/read-all", authorize, markAllRead);
router.delete("/:id", authorize, deleteNotification);
router.delete("/", authorize, deleteAllNotifications);
